<x-app-layout>
    ...
    <div class="px-4 py-5">
        ...
        {{-- Ringkasan Cash vs Non-Cash (saldo riil saat ini) --}}
        <div class="bg-[#262135] rounded-2xl p-4 mb-4 text-white">
            ...
            <div class="grid grid-cols-2 gap-4 mt-3 pt-3 border-t border-white/10">
                <div>
                    <p class="text-[10px] text-white/50">💵 Saldo Cash</p>
                    <p class="text-sm font-medium">Rp{{ number_format($cashFisik, 0, ',', '.') }}</p>
                </div>
                <div>
                    <p class="text-[10px] text-white/50">Saldo Non-Cash</p>
                    <p class="text-sm font-medium">Rp{{ number_format($totalRekening, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
